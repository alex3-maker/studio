...
export const mockDuels: Duel[] = [
  {
    ...
    options: [
      { id: 'opt-1a', title: 'Metrópolis de Neón', imageUrl: 'https://placehold.co/600x600/1e40af/ffffff.png', 'data-ai-hint': 'neon metropolis', votes: 120 },
  ...
  },
  {
    ...
    options: [
      { id: 'opt-2a', title: 'Dragón', imageUrl: 'https://placehold.co/600x600/b91c1c/ffffff.png', 'data-ai-hint': 'dragon fantasy', votes: 250 },
      { id: 'opt-2b', title: 'Grifo', imageUrl: 'https://placehold.co/600x600/f59e0b/ffffff.png', 'data-ai-hint': 'griffin fantasy', votes: 180 },
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'opt-3a', title: 'Golden Retriever', imageUrl: 'https://placehold.co/600x600/eab308/ffffff.png', 'data-ai-hint': 'golden retriever', votes: 300 },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'opt-4b', title: 'Montañas Nevadas', imageUrl: 'https://placehold.co/600x600/f1f5f9/000000.png', 'data-ai-hint': 'snowy mountains', votes: 210 },
    ],
    creator: { id: 'user-1', name: 'Alex Doe', avatarUrl: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=2080&auto=format&fit=crop' },
    type: 'A_VS_B',
    status: 'closed',
  },
  {
    ...
    options: [
      { id: 'opt-5a', title: 'Gatos', imageUrl: 'https://placehold.co/600x600/1e293b/ffffff.png', 'data-ai-hint': 'cat portrait', votes: 500 },
      { id: 'opt-5b', title: 'Perros', imageUrl: 'https://placehold.co/600x600/7c2d12/ffffff.png', 'data-ai-hint': 'dog portrait', votes: 501 },
    ],
    creator: { id: 'user-1', name: 'Alex Doe', avatarUrl: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=2080&auto=format&fit=crop' },
    type: 'A_VS_B',
    status: 'closed',
