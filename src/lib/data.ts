...
export const mockDuels: Duel[] = [
  {
    ...
    options: [
      { id: 'opt-1a', title: 'Metrópolis de Neón', imageUrl: 'https://images.unsplash.com/photo-1549402517-57c2438a4f54?q=80&w=2070&auto=format&fit=crop', votes: 120 },
      { id: 'opt-1b', title: 'Eco-Utopía', imageUrl: 'https://images.unsplash.com/photo-1624388392534-884d000139b8?q=80&w=2060&auto=format&fit=crop', votes: 95 },
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'opt-2a', title: 'Dragón', imageUrl: 'https://images.unsplash.com/photo-1549608276-578a159c14d9?q=80&w=1974&auto=format&fit=crop', votes: 250 },
      { id: 'opt-2b', title: 'Grifo', imageUrl: 'https://images.unsplash.com/photo-1626241192931-15c1bf69cb3b?q=80&w=2070&auto=format&fit=crop', votes: 180 },
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'opt-3a', title: 'Golden Retriever', imageUrl: 'https://images.unsplash.com/photo-1599723383286-95123971c2d9?q=80&w=1976&auto=format&fit=crop', votes: 300 },
      { id: 'opt-3b', title: 'Corgi', imageUrl: 'https://images.unsplash.com/photo-1597633425046-08ebb7960e75?q=80&w=1974&auto=format&fit=crop', votes: 350 },
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'opt-4a', title: 'Playa Tropical', imageUrl: 'https://images.unsplash.com/photo-1507525428034-b723a996f6ea?q=80&w=2070&auto=format&fit=crop', votes: 190 },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'opt-5b', title: 'Perros', imageUrl: 'https://images.unsplash.com/photo-1537151608828-ea2b11777ee8?q=80&w=1988&auto=format&fit=crop', votes: 501 },
    ],
    creator: { id: 'user-1', name: 'Alex Doe', avatarUrl: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=2080&auto=format&fit=crop' },
    type: 'A_VS_B',
    status: 'closed',
